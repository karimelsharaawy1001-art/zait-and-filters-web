        ...
        <>
          ...
          >
            ...
            <div style={{ padding: '20px 20px 16px', borderBottom: '1px solid #242424', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
              ...
              <button onClick={() => setOpen(false)} style={{ width: '32px', height: '32px', borderRadius: '50%', border: 'none', background: '#242424', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#475569' }}>
                <X size={16} />
              </button>
            </div>
            ...
            {cart.length > 0 && (
              <div style={{ padding: '16px 20px 24px', borderTop: '1px solid #242424', flexShrink: 0, background: '#1c1c1c' }}>
                ...
                <Link href="/cart" onClick={() => setOpen(false)}
                  style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', width: '100%', padding: '11px', background: '#161616', color: '#475569', textDecoration: 'none', borderRadius: '12px', fontWeight: '700', fontSize: '0.82rem', border: '1px solid #2a2a2a' }}>
                  عرض السلة كاملة
                </Link>
                {/* Trust */}
