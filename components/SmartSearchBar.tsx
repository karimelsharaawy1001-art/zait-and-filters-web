  ...
  return (
    <div ref={containerRef} style={{ position: 'relative', width: '100%' }}>
      ...
      <div style={{
        ...
        background: '#ffffff', border: `1.5px solid ${open ? '#22c55e' : '#e5e7eb'}`,
        ...
        <input
          ...
          style={{
            ...
            fontSize: compact ? '0.88rem' : '1rem', color: '#1a1a1a', direction: 'rtl',
            fontFamily: 'inherit',
          }}
        />
      ...
      {open && suggestions.length > 0 && (
        <div style={{
          ...
          background: '#ffffff', borderRadius: '16px', zIndex: 9999,
          ...
          {suggestions.map((s, i) => (
            <button
              ...
              style={{
                ...
                borderBottom: i < suggestions.length - 1 ? '1px solid #ffffff' : 'none',
            ...
            >
              ...
              {s.type === 'product' && s.image ? (
                <img
                  ...
                  style={{ width: '38px', height: '38px', objectFit: 'contain', borderRadius: '8px', background: '#f9fafb', border: '1px solid #f3f4f6', flexShrink: 0 }}
                />
              ) : s.type === 'smart' ? (
                <div style={{ width: '38px', height: '38px', borderRadius: '8px', background: '#f0fdf4', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, border: '1px solid #166534' }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{
                  ...
                  color: s.type === 'smart' ? '#15803d' : '#e5e7eb',
          ...
          {/* Footer hint */}
          <div style={{ padding: '7px 14px', background: '#f9fafb', borderTop: '1px solid #ffffff', fontSize: '0.68rem', color: '#9ca3af', display: 'flex', alignItems: 'center', gap: '6px' }}>
            <kbd style={{ background: '#e5e7eb', borderRadius: '4px', padding: '1px 5px', fontSize: '0.65rem', color: '#6b7280', fontFamily: 'monospace' }}>↑↓</kbd>
            للتنقل
            <kbd style={{ background: '#e5e7eb', borderRadius: '4px', padding: '1px 5px', fontSize: '0.65rem', color: '#6b7280', fontFamily: 'monospace' }}>Enter</kbd>
            للاختيار
            <kbd style={{ background: '#e5e7eb', borderRadius: '4px', padding: '1px 5px', fontSize: '0.65rem', color: '#6b7280', fontFamily: 'monospace' }}>Esc</kbd>
            إغلاق
          </div>
        </div>
      )}
