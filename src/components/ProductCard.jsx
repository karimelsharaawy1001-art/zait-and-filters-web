...
const ProductCard = ({ product, isCompact = false }) => {
    ...
    return (
        <article className={`product-card group relative flex flex-col !gap-0 !space-y-0 !justify-start bg-white rounded-premium shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:translate-y-[-5px] w-full max-w-full lg:max-w-none mx-auto h-full ${isCompact ? 'px-0' : 'px-0.5'}`}>
