...
const Hero = () => {
    ...
    return (
        <div className="relative bg-gray-900 text-white min-h-[600px] md:h-[600px] flex items-center py-10 md:py-0">
                    ...
                    >
                        ...
                        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center z-20">
                            <div className={`w-full md:w-2/3 text-center pt-20 md:pt-0 ${i18n.language === 'ar' ? 'md:text-right' : 'md:text-left'}`}>
                                ...
                                <p className={`text-gray-200 mb-10 drop-shadow-md mx-auto ${i18n.language === 'ar' ? 'text-2xl md:text-3xl md:mr-0 leading-[1.5] max-w-2xl' : 'text-lg md:ml-0 leading-relaxed max-w-lg'}`}>
            ...
            {/* Car Selector (Mobile: Halfway Overlap, Desktop: Inside Hero) */}
            <div className="absolute bottom-0 md:bottom-8 left-0 right-0 transform translate-y-1/2 md:translate-y-0 z-40 pointer-events-none">
