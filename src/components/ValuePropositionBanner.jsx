            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                    {features.map((feature, idx) => (
                        <div
                            key={idx}
                            className={`flex flex-col md:flex-row ${isRTL ? 'md:flex-row-reverse text-center md:text-right' : 'md:flex-row text-center md:text-left'} items-center gap-3 md:gap-5 p-2 md:p-4 rounded-2xl hover:bg-gray-50 transition-all duration-300 group cursor-default`}
                        >
