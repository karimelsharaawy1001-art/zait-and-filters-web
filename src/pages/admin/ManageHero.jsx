                ...
                <div className="bg-white p-6 rounded-xl shadow-md mb-8 border border-gray-100">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="md:col-span-2">
                            <label className="block text-sm font-bold text-black mb-2">Slide Image</label>
                            <ImageUpload
                        ...
                        <div>
                            <label className="block text-sm font-bold text-black mb-1">Title (English)</label>
                            <input
                                type="text"
                                name="title_en"
                                value={formData.title_en}
                                onChange={handleChange}
                                className="w-full border border-gray-100 rounded-lg p-3 bg-gray-50 text-black focus:ring-admin-red outline-none transition-all placeholder-gray-300"
                                required
                            />
                        </div>

                        <div>
                            <label className="block text-sm font-bold text-black mb-1">Title (Arabic)</label>
                            <input
                                type="text"
                                name="title_ar"
                        ...
                        <div>
                            <label className="block text-sm font-bold text-black mb-1">Subtitle (English)</label>
                            <textarea
                                name="subtitle_en"
                        ...
                        <div>
                            <label className="block text-sm font-bold text-black mb-1">Subtitle (Arabic)</label>
                            <textarea
                                name="subtitle_ar"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full border border-gray-100 rounded-lg p-3 bg-gray-50 text-black focus:ring-admin-red outline-none transition-all"
                            />
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <label htmlFor="isActive" className="text-sm font-bold text-black">Display this slide</label>
                        </div>
                        ...
                        <div className="md:col-span-2 flex justify-end gap-3 mt-4">
                            <button
                                type="button"
                                onClick={resetForm}
                                className="px-6 py-2 border border-gray-100 rounded-lg hover:bg-gray-50 text-black font-bold transition"
                            >
                                Cancel
                            </button>
                            <button
                                type="submit"
                                disabled={loading}
                                className="bg-admin-red text-white px-8 py-2 rounded-lg hover:bg-admin-red-dark transition flex items-center gap-2 disabled:bg-admin-red/30 shadow-lg shadow-admin-red/20 font-bold"
                            >
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                <table className="w-full">
                    <thead className="bg-gray-50 border-b border-gray-100">
                        <tr>
                            <th className="px-6 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-widest">Preview</th>
                            <th className="px-6 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-widest">Title (EN / AR)</th>
                        ...
                        {loading && slides.length === 0 ? (
                            ...
                            <tr key={slide.id} className="hover:bg-gray-50 transition">
                                <td className="px-6 py-4">
                                    <div className="h-16 w-28 rounded-md overflow-hidden bg-gray-50 border border-gray-100">
                                        <img src={slide.imageUrl} alt="" className="w-full h-full object-cover" />
                                    </div>
                                </td>
                                <td className="px-6 py-4">
                                    <div className="text-sm font-bold text-black">{slide.title_en}</div>
                                    <div className="text-xs text-gray-400" dir="rtl">{slide.title_ar}</div>
                                </td>
