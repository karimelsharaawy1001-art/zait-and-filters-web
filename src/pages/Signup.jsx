            ...
            <div className="max-w-md mx-auto">
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                    <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-10 text-center">
                        <UserPlus className="h-12 w-12 text-orange-500 mx-auto mb-4" />
                        <h2 className="text-3xl font-black text-white uppercase tracking-wider mb-2">Join Us</h2>
                    ...
                    <form onSubmit={handleSubmit} className="p-10 space-y-6">
                        ...
                        <p className="text-center text-sm text-gray-500 font-medium">
                            Already have an account? <Link to="/login" className="text-orange-600 font-black hover:underline">Sign In</Link>
                        </p>
                    </form>
                </div>
            </div>
