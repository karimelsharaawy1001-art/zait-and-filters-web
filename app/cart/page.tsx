...
export default function CartPage() {
  ...
  if (!isInitialized) return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '60vh', flexDirection: 'column', gap: '12px' }}>
      <Loader2 size={32} color="#e50914" style={{ animation: 'spin 0.8s linear infinite' }} />
          ...
          <aside className="cart-summary">
            <div className="summary-card">
              ...
              <div className="trust-row">
                {[
                  { icon: <ShieldCheck size={14} color="#e50914" />, text: 'دفع آمن ومشفر 100%' },
                  { icon: <Truck size={14} color="#e50914" />, text: 'شحن لباب البيت في جميع المحافظات' },
                  { icon: <RotateCcw size={14} color="#e50914" />, text: 'ضمان الاستبدال على جميع المنتجات' },
                ].map((b, i) => (
