...
export default async function CarsHubPage() {
  ...
  return (
    <>
      ...
      <div dir="rtl" style={{ background: '#f9fafb', minHeight: '100vh', fontFamily: 'inherit' }}>

        {/* Hero */}
        <div style={{ background: 'linear-gradient(135deg, #e5e7eb, #6b7280)', padding: '48px 20px', textAlign: 'center' }}>
          <h1 style={{ fontSize: 'clamp(1.6rem, 4vw, 2.4rem)', fontWeight: '900', color: '#fff', margin: '0 0 12px' }}>
            قطع غيار السيارات حسب الموديل
          </h1>
          <p style={{ color: '#6b7280', fontSize: '0.95rem', maxWidth: '560px', margin: '0 auto', lineHeight: 1.7 }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 0' }}>
                ...
                <Link key={makeKey} href={`/cars/${makeKey.toLowerCase()}`} className="hub-card" style={{ background: bg }}>
                  <div className="hub-logo-wrap">
                    {logoUrl
                      ...
                      : <span style={{ fontSize: '0.7rem', fontWeight: '900', color: '#6b7280' }}>{makeKey}</span>
                    }
                  </div>
          ...
          {/* SEO text */}
          <div style={{ background: '#ffffff', border: '1px solid #f3f4f6', borderRadius: '20px', padding: '28px', margin: '40px 20px 0' }}>
            <h2 style={{ fontSize: '1.05rem', fontWeight: '900', color: '#1a1a1a', margin: '0 0 12px' }}>
              قطع غيار السيارات الأصلية في مصر — زيت أند فلترز
            </h2>
            <p style={{ color: '#6b7280', fontSize: '0.88rem', lineHeight: 1.8, margin: 0 }}>
