...
const subTitle: any = { color: '#666', fontSize: '1.1rem' };
...
const searchBtn: any = { background: '#1a1a1a', color: '#fff', border: 'none', padding: '0 30px', borderRadius: '15px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 'bold' };
const resultsArea: any = { marginTop: '30px' };
const ordersList: any = { display: 'flex', flexDirection: 'column', gap: '20px' };
const orderCard: any = { background: '#fff', borderRadius: '24px', border: '1px solid #eee', padding: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' };
const cardHeader: any = { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' };
const statusBadge = (s:string):any => ({ display: 'flex', alignItems: 'center', gap: '6px', background: s==='pending'?'#fff7ed':'#f0fdf4', color: s==='pending'?'#c2410c':'#166534', padding: '6px 12px', borderRadius: '10px', fontSize: '0.85rem', fontWeight: 'bold' });
...
const infoRow: any = { display: 'flex', alignItems: 'center', gap: '10px', color: '#444' };
const paymentSummary: any = { marginTop: '10px', padding: '15px', background: '#f9f9f9', borderRadius: '15px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' };
