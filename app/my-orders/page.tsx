...
const orderCard: any = { background: '#1c1c1c', borderRadius: '24px', border: '1px solid #2a2a2a', padding: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' };
const cardHeader: any = { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' };
const statusBadge = (s:string):any => ({ display: 'flex', alignItems: 'center', gap: '6px', background: s==='pending'?'#1c1c1c':'#1a0d0d', color: s==='pending'?'#fb923c':'#991b1b', padding: '6px 12px', borderRadius: '10px', fontSize: '0.85rem', fontWeight: 'bold' });
