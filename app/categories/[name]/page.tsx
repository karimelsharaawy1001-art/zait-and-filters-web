...
const CATEGORY_SEO: Record<string, { description: string; keywords: string[] }> = {
  'فلاتر': {
    description: 'اشتري فلاتر سيارات أصلية — فلتر زيت، فلتر هواء، فلتر تكييف، فلتر بنزين لجميع موديلات السيارات. شحن سريع لباب البيت في جميع المحافظات مع ضمان الجودة.',
    keywords: [
  ...
  'زيوت موتور': {
    description: 'اشتري زيت موتور أصلي — موبيل، شل، كاسترول، توتال، تيدكس. زيوت تخليقية كاملة ونصف تخليقية لجميع السيارات. شحن سريع لباب البيت.',
    keywords: [
  ...
  'زيوت فتيس و دبرياج و باور': {
    description: 'زيت فتيس وزيت دبرياج وزيت باور ستيرينج أصلية. جميع الماركات والمواصفات لجميع أنواع السيارات مع شحن سريع لباب البيت.',
    keywords: [
  ...
  'الفرامل': {
    description: 'قطع فرامل سيارات أصلية — تيل فرامل، طنابير، ماستر فرامل لجميع موديلات السيارات. قطع أصلية مضمونة مع شحن سريع.',
    keywords: [
  ...
  'عفشة': {
    description: 'قطع عفشة سيارات أصلية — مساعدين، بلية عجل، مقصات، قواعد وشدادات لجميع موديلات السيارات. شحن سريع لباب البيت مع ضمان.',
    keywords: [
  ...
  'سيور و بلي': {
    description: 'سيور وبلي سيارات أصلية — سير توقيت، سير مجموعة، سير دينامو، سير كاتينة، بلي وشدادات. شحن لباب البيت مع ضمان الجودة.',
    keywords: [
  ...
  'دورة البنزين': {
    description: 'قطع دورة البنزين والوقود أصلية — طلمبة بنزين، إنجكتورات، منظمات ضغط وقود. لجميع أنواع السيارات مع شحن لباب البيت.',
    keywords: [
  ...
  'بوجيهات و سلوك بوجيهات و موبينة': {
    description: 'بوجيهات وموبينة وسلوك بوجيهات أصلية — NGK، Bosch، Denso، Champion لجميع موديلات السيارات. شحن سريع مع ضمان.',
    keywords: [
  ...
  'حساسات و قطع كهربائية': {
    description: 'حساسات وقطع كهربائية سيارات أصلية — حساس شكمان، حساس حرارة، حساس دعسة، حساس ABS. لجميع موديلات السيارات مع شحن سريع.',
    keywords: [
  ...
  'جوانات و أويل سيل': {
    description: 'جوانات وأويل سيل سيارات أصلية. لمنع تسرب الزيت وإحكام غلق المحرك لجميع موديلات السيارات. شحن سريع لباب البيت.',
    keywords: [
  ...
  'مستلزمات عمرة موتور': {
    description: 'مستلزمات عمرة موتور أصلية — طقم بستم، عامود كامة، رسمات. قطع أصلية مضمونة لجميع أنواع الموتورات مع شحن سريع.',
    keywords: [
  ...
  'قطع الموتور و ملحقاته': {
    description: 'قطع موتور سيارات أصلية. عامود كرنك، سلندرات، مكابس وجميع قطع الموتور لكل موديلات السيارات. شحن سريع لباب البيت.',
    keywords: [
  ...
  'دبرياج و قطع فتيس': {
    description: 'قطع دبرياج وفتيس سيارات أصلية. طقم دبرياج، قرص دبرياج، صينية دبرياج لجميع موديلات السيارات. شحن لباب البيت مع ضمان.',
    keywords: [
  ...
  'إطارات': {
    description: 'اشتري إطارات سيارات أصلية. إطارات لجميع أحجام ومواصفات السيارات من أشهر الماركات العالمية. شحن سريع لباب البيت.',
    keywords: [
  ...
  'مساحات': {
    description: 'مساحات زجاج سيارات أصلية. مساحات بأفضل جودة لجميع موديلات السيارات. شحن سريع لباب البيت مع ضمان الجودة.',
    keywords: [
...
export async function generateMetadata(
  ...
  const title = `${categoryName} أصلية | زيت أند فلترز`;
