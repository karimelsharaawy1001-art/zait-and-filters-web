                          ...
                          <div className="list-card-body" dir="rtl">
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' as const }}>
                              ...
                              {origin && (() => { const flag = originFlag(origin); return (
                                <span style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.68rem', color: '#1a1a1a', fontWeight: '800', background: 'linear-gradient(135deg, #f59e0b, #d97706)', borderRadius: '8px', padding: '2px 8px', boxShadow: '0 2px 6px rgba(245,158,11,0.35)' }}>
                                  {flag ? <span style={{ fontSize: '0.85rem', lineHeight: 1 }}>{flag}</span> : <Globe size={11} color="#1a1a1a" />} {origin}
                                </span>
                              ); })()}
                            </div>
