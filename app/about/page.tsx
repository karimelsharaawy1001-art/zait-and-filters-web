...
export default function AboutPage() {
  ...
  return (
    <div style={{ direction: 'rtl', background: '#f9fafb', minHeight: '100vh', fontFamily: 'inherit' }}>
      ...
      <div style={{
        ...
        {/* decorative circles */}
        <div style={{ position: 'absolute', top: '-60px', left: '-60px', width: '250px', height: '250px', borderRadius: '50%', background: 'rgba(0,0,0,0.04)' }} />
        <div style={{ position: 'absolute', bottom: '-80px', right: '-40px', width: '300px', height: '300px', borderRadius: '50%', background: 'rgba(0,0,0,0.04)' }} />

        <div style={{ position: 'relative', zIndex: 1, maxWidth: '750px', margin: '0 auto' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'rgba(0,0,0,0.06)', borderRadius: '50px', padding: '8px 20px', marginBottom: '25px' }}>
            <Wrench size={18} color="#16a34a" />
            <span style={{ color: '#16a34a', fontWeight: '700', fontSize: '0.9rem' }}>منصتك المصرية لصيانة عربيتك</span>
          </div>
          <h1 style={{ color: '#fff', fontSize: 'clamp(2rem, 5vw, 3.2rem)', fontWeight: '900', margin: '0 0 20px', lineHeight: 1.3 }}>
            زيت أند فلترز 🛢️
          </h1>
          <p style={{ color: '#15803d', fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', lineHeight: 1.9, margin: 0 }}>
      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: '60px 30px' }}>
        ...
        {/* ===== WHO WE ARE ===== */}
        <div style={{ background: '#ffffff', borderRadius: '30px', padding: '45px', marginBottom: '40px', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                ...
                <p style={{ margin: 0, color: '#374151', lineHeight: 1.85, fontSize: '1rem' }}>{text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', top: '-40px', left: '-40px', width: '200px', height: '200px', borderRadius: '50%', background: 'rgba(0,0,0,0.05)' }} />
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ color: '#15803d', fontSize: '1.05rem', lineHeight: 1.9, margin: '0 0 18px' }}>
            ...
            <p style={{ color: '#15803d', fontSize: '1.05rem', lineHeight: 1.9, margin: 0 }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <div style={{ textAlign: 'center', marginBottom: '35px' }}>
            ...
            <p style={{ margin: '10px 0 0', color: '#9ca3af', fontSize: '0.95rem' }}>بنينا خدماتنا على 4 قواعد أساسية عشان نستاهل ثقتك</p>
          </div>
            ...
            {features.map((f, i) => (
              <div key={i}
                ...
                style={{
                  ...
                  border: `2px solid ${hoveredCard === i ? f.border : '#e5e7eb'}`,
        ...
        {/* ===== CLOSING CTA ===== */}
        <div style={{
          background: '#ffffff', borderRadius: '30px', padding: '45px',
          ...
          <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="/contact" style={{
              ...
              padding: '13px 28px', fontWeight: '800', fontSize: '1rem',
              textDecoration: 'none', border: '2px solid #16a34a',
            }}>
